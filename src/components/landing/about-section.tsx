        ...
        <div className="container grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
          <div className="space-y-4">
            ...
            <p className="max-w-[600px] text-foreground/80 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed text-left">
              At <span className="font-bold"><span className="text-primary">WinWin</span>Windowtint</span>, we are dedicated to providing San Antonio with the highest quality window films and installation services.
